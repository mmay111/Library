...
$(document).ready(function () {
    ...
    var oTable = $('#dyntable').dataTable({
        ...
        "aaSorting": [[0, 'desc']],
        "bServerSide": true,
        "sAjaxSource": "/Company/Job/GetJobs",
        "oLanguage": {
        ...
        "aoColumns": [
            ...
            {
                "sName": "RecordStatusName"
            },
            {
                "sName": "AdvertisingStatusName"
            },
            {
                "sName": "Ayarlar"
            }
    ...
    $('.table-scrollable').addClass('table-scrollableList').removeClass('table-scrollable');
