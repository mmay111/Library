...
$(document).ready(function () {
    ...
    var oTable = $('#dyntable').dataTable({
        ...
        "aaSorting": [[0, 'desc']],
        "bServerSide": true,
        "sAjaxSource": "/Company/Recruitment/GetRecruitments?CompanyID=" + $("#CompanyID").val(),
        "oLanguage": {
    ...
    //    var s = "/Company/Recruitment/GetRecruitments?CompanyID=" + $("#CompanyID").val();
    //    $("#dyntable").fadeOut(150);
